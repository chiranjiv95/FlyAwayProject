...
<head>
    ...
    <style>
        ...
        .bgimg-1 {
            ...
            background-image: url("img/airfly1.jpg");
            min-height: 100%;
        }
        .w3-bar .w3-button {
            padding: 16px;
...
<body>
    ...
    <header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
        ...
        <div class="w3-display-centre w3-text-white" style="padding:48px">
            <span class="w3-jumbo w3-hide-small">All Set to FlyAway?</span><br>
            <span class="w3-large">Catch Flights Not Feelings.</span>
        </div>
